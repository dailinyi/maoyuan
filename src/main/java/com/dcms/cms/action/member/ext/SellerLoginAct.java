...
@Controller
public class SellerLoginAct {
	private static final Logger log = LoggerFactory.getLogger(SellerLoginAct.class);

	public static final String COOKIE_ERROR_REMAINING = "_error_remaining";
	public static final String TPL_INDEX = "tpl.index";
	public static final String LOGIN_INPUT = "tpl.loginInput";

	@RequestMapping(value = "/seller/login.jspx", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/seller/login.jspx", method = RequestMethod.POST)
	...
	@RequestMapping(value = "/seller/logout.jspx")
