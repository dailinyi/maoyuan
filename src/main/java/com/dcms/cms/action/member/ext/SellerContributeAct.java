 ...
 */
@Controller
public class SellerContributeAct {
	private static final Logger log = LoggerFactory
			.getLogger(SellerContributeAct.class);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_list.jspx")
	public String list(String queryTitle, Integer queryChannelId,
		...
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_SELLER_MEMBER, CONTRIBUTE_LIST);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_add.jspx")
	public String add(HttpServletRequest request, ModelMap model) {
		...
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_SELLER_MEMBER, CONTRIBUTE_ADD);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_save.jspx")
	public String save(String title, String author, String description,
			String txt, String tagStr, Integer modelId, String captcha,
		...
		Integer channelId = Integer.valueOf(cmsDictionaryMng.findValue("sellerAdCheck", "栏目ID").getValue());
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_edit.jspx")
	public String edit(Integer id, HttpServletRequest request,
		...
		model.addAttribute("channelList", channelList);
		return FrontUtils.getTplPath(request, site.getSolutionPath(),
				TPLDIR_SELLER_MEMBER, CONTRIBUTE_EDIT);
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_update.jspx")
	public String update(Integer id, String title, String author,
			String description, String txt, String tagStr,
			String nextUrl, HttpServletRequest request,
			HttpServletResponse response, ModelMap model) {
		CmsSite site = CmsUtils.getSite(request);
		CmsUser user = CmsUtils.getUser(request);
	 ...
	 * @return
	 */
	@RequestMapping(value = "/seller/contribute_delete.jspx")
