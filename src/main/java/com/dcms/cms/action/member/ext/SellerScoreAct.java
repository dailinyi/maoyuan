 ...
 */
@Controller
public class SellerScoreAct {
    private static final Logger log = LoggerFactory.getLogger(SellerScoreAct.class);
    public static final String SCORE_LIST = "tpl.memberScore";

    @RequestMapping(value = "/seller/scoreList.jspx", method = RequestMethod.GET)
    public String list(String queryOrderId,Integer pageNo,HttpServletRequest request, HttpServletResponse response,
        ...
        return FrontUtils.getTplPath(request, site.getSolutionPath(),
                TPLDIR_SELLER_MEMBER, SCORE_LIST);
    }
