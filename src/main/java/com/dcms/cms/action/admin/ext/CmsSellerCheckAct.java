...
public class CmsSellerCheckAct {
    ...
    @RequestMapping("/sellerCheck/o_reject.do")
    ...
    @RequestMapping("/sellerCheck/o_check.do")
    ...
    @RequestMapping("/sellerCheck/v_edit.do")
    ...
    @RequestMapping("/sellerCheck/o_update.do")
    public String update(String queryStatus,Integer queryOrderBy, Content bean, ContentExt ext, ContentTxt txt,
