...
public class CmsSellerAct {
    ...
    @RequestMapping("/seller/v_edit.do")
    ...
    @RequestMapping("/seller/o_update.do")
    public String update(Integer id, String email, String password,
                         Boolean disabled, CmsUserExt ext, Integer groupId,Byte rate,
    ...
    @RequestMapping(value = "/seller/v_check_username.do")
